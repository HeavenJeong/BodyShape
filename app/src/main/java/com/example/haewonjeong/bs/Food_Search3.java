...
public class Food_Search3 extends Activity implements TextWatcher,AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new MySQLiteOpenHelper(Food_Search3.this);
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                helper2 = new FoodHelper(Food_Search3.this);
                ...
                db.insert("food_record",null,values);
