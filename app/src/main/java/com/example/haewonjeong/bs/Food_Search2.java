...
public class Food_Search2 extends Activity implements TextWatcher,AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new MySQLiteOpenHelper(Food_Search2.this);
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                helper2 = new FoodHelper(Food_Search2.this);
                db3 = helper2.getWritableDatabase();
                ...
                db3.insert("food_record",null,values);
    ...
    public void select() {
        ...
        while (c.moveToNext()) {
            ...
            if(name.contains(aa))  //aa.equals(key)
            {
